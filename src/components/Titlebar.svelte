<script>
    ...
    const { maximize, unmaximize, minimize } = appWindow;
...
<div data-tauri-drag-region class="titlebar flex row space noselect">
    <div class="flex row">
        <svg width="23" height="23" style="margin: auto 6px;" viewBox="0 0 176 176" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {#if can_maximize}
            <button style="" on:click={() => request_maximize()}>
                ...
                {:else}
                    ...
                    >
                        <path
                            d="M9 3.5H0.5V0.5H12.5V12.5H9.5V4V3.5H9Z"
                            stroke="var(--fg)"
                        />
                        <rect
                            x="0.5"
        ...
        <button on:click={() => request_exit()} class="exit">
            ...
            >
                <rect
                    ...
                    width="1.00144"
                    height="16"
                    transform="rotate(-45 0.34375 1.05859)"
                    fill="var(--fg)"
                />
                <rect
                    x="11.6445"
                    ...
                    width="1"
                    height="16"
                    transform="rotate(45 11.6445 0.333984)"
                    fill="var(--fg)"
                />
            </svg>
        </button>
